...
class DintableWidget extends StatelessWidget {
  final DintableModel din;

  const DintableWidget({super.key, required this.din});
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: CachedImage(imgurl: din.imageUrl), // Dynamic image
                ),
              ),
              Positioned(
                top: 14,
              ...
              Positioned(bottom: 15, left: 15, child: RatingWidget(rating: din.rating)),
            ],
          ),
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(din.name, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12)),
                ...
                Row(
                  children: [
                    Text(
                      "Price \$ ${din.price.toStringAsFixed(2)}",
